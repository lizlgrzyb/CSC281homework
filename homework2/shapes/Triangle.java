...
/**
 * This class is inheriting BasicShape to draw a triangle.
  */
...
public class Triangle extends BasicShape {
  ...
  public void draw(Graphics g) {
    ...
    /*Lists to hold the x and y coordinates of the Triangle.
     */
    List<Integer> xPoints = new ArrayList<Integer>();
    List<Integer> yPoints = new ArrayList<Integer>();

    // Create the x coordinates of the three vertices of the Triangle
    xPoints.add(this.x -100);
    xPoints.add(this.x);
    xPoints.add(this.x + 100);

    // Create the y coordinates of the three vertices of the Triangle
    yPoints.add(this.y);
    yPoints.add(this.y + 150);
    yPoints.add(this.y);
    ...
    Color fillColor = new Color(74, 180, 206, 255);
