...
/**
 * This class is inheriting BasicShape to draw a pentagon.
  */
...
public class Pentagon extends BasicShape {
  ...
  public void draw(Graphics g) {
    ...
    /*Lists to hold the x and y coordinates of the petnagon.
     */
    List<Integer> xPoints = new ArrayList<Integer>();
    List<Integer> yPoints = new ArrayList<Integer>();

    // Create the x coordinates of the vertices of the pentagon
    xPoints.add(this.x -50);
    ...
    // Create the y coordinates of the three vertices of the pentagon
    yPoints.add(this.y);
    yPoints.add(this.y + 100);
    ...
    Color fillColor = new Color(146, 112, 175, 255);
