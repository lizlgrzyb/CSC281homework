...
/**
 * This class is inheriting BasicShape to draw a hexagon.
  */
...
public class Hexagon extends BasicShape {
  ...
  public void draw(Graphics g) {
    ...
    /*Lists to hold the x and y coordinates of the hexagon.
     */
    List<Integer> xPoints = new ArrayList<Integer>();
    List<Integer> yPoints = new ArrayList<Integer>();

    // Create the x coordinates of the vertices of the hexagon
    xPoints.add(this.x);
    ...
    // Create the y coordinates of the three vertices of the hexagon
    yPoints.add(this.y);
    yPoints.add(this.y + 80);
    yPoints.add(this.y + 160);
    yPoints.add(this.y + 240);
    yPoints.add(this.y + 160);
    yPoints.add(this.y + 80);
    ...
    Color fillColor = new Color(119, 186, 151, 255);
